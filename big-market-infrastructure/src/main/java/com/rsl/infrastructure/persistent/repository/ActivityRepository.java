...
import com.rsl.domain.activity.event.ActivitySkuStockZeroMessageEvent;
...
public class ActivityRepository implements IActivityRepository {
        ...
        try {
            ...
            transactionTemplate.execute(status -> {
                try {
                    ...
                    throw new AppException(ResponseCode.INDEX_DUP.getCode());//主键冲突异常
                }
            });
        } finally {
            dbRouter.clear();
    ...
    @Override
    public ActivityAccountMonthEntity queryActivityAccountMonthByUserId(String userId, Long activityId, String
            month) {
        // 1. 查询账户
