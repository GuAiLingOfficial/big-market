...
import com.rsl.domain.activity.service.IRaffleActivityPartakeService;
import com.rsl.domain.activity.service.IRaffleActivitySkuProductService;
import com.rsl.domain.activity.service.armory.IActivityArmory;
import com.rsl.domain.award.model.entity.UserAwardRecordEntity;
import com.rsl.domain.award.model.valobj.AwardStateVO;
...
import com.rsl.trigger.api.dto.*;
...
/**
 * @ description:抽奖活动服务 注意；在不引用 application/case 层的时候，就需要让接口实现层来做领域的串联。
